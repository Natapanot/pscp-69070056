...
```input เก็บ ค่าอาหาร output บอกราคาที่ต้องจ่ายหลังจากรวมค่าบริการกับภาษี```
...
```นำคำมาใส่ในกรอบ ** ด้วยการใช้ len```
...
```อยากทดลอบว่าใช้อักษรเยอะๆได้มั้ย```
