...
| Item | Answer |
|---|---|
| OJ problem number/title | 3299/[LEARNING LOGS] แปลงดอกไม้|
| OJ submission ID, if submitted | 669016 |
| OJ status | Pass |
...
```สอนให้ใช้ syntax แบบใหม่ๆและคำนวนทีละตอน```
