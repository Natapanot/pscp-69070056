...
```ให้ตัวแปร reverse_name เก็บชื่อหลังสลับไว้,ให้ name -1 คือการอ่านทีละ -1 คือการอ่านจากหลังไปหน้า```
...
```หา syntax ที่สามารถอ่านค่า/ตัวอักษรถอยหลังได้```
